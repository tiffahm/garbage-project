...
public class WeeklySub extends AppCompatActivity {
    FirebaseFirestore db = FirebaseFirestore.getInstance();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weekly_sub);
...
// Add a new document with a generated ID
        ...
        Toast.makeText(WeeklySub.this,"your request is being processed", Toast.LENGTH_SHORT);
